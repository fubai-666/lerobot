...
@ProcessorStepRegistry.register(name="couette_pi0_new_line_processor")
class CouettePi0NewLineProcessor(ComplementaryDataProcessorStep):
    """
...
def make_couette_pi0_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for the Couette-PI0 policy.
    ...
    input_steps: list[ProcessorStep] = [
        ...
        AddBatchDimensionProcessorStep(),
        CouettePi0NewLineProcessor(),  # Add newlines before tokenization for PaliGemma
        TokenizerProcessorStep(
